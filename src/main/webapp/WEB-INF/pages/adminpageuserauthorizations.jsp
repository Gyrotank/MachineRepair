	...
	<div id="content">
		<div class="tabs-content">
			...
			<div class="content" id="user_auths">
				...
				<br> <a name="add_new_user_authorization"></a>
				<h2>
					<spring:message code="label.adminpage.addNewUserAuthorization" />
				</h2>
					...
					<table>
						<tr>
							<td><label> <spring:message
										code="label.adminpage.addNewUserAuthorization.userFrom" />
							</label></td>
							<td><form:select path="userId">
									<option value="0">
										<spring:message
											code="label.adminpage.addNewUserAuthorization.selectUser" />
									</option>
									<c:forEach var="uau" items="${user_authorizations_short_users}">
										<c:choose>
											<c:when
												test="${userAuthorizationAddDTO.userId == uau.userId}">
						...
						<tr>
							<td><label> <spring:message
										code="label.adminpage.userAuthorizations.role" />
							</label></td>
							<td><form:select path="role">
									<option value="">
										<spring:message
											code="label.adminpage.addNewUserAuthorization.selectRole" />
									</option>

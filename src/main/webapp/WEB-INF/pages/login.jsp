...
<body>
	...
	<h1>
		<br>
		<spring:message code="label.loginpage.header" />
	</h1>
	<c:choose>
		...
		<table>
			...
			<tr>
				<td align="right"><spring:message
						code="label.loginpage.password" /></td>
				<td><input type="password" maxlength="50" name="password" /></td>
			</tr>
			<tr>
				<td align="right"><spring:message
						code="label.loginpage.remember" /></td>
				<td><input type="checkbox" name="_spring_security_remember_me" /></td>
			</tr>
			<tr>
				<td colspan="2" align="right"><input type="submit"
					value="<spring:message code="label.loginpage.buttonLogin" />" /> <input
					type="reset"
					value="<spring:message code="label.loginpage.buttonReset" />" /></td>
			</tr>
		</table>
	</form>
</body>

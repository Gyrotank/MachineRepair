...
<body>
	...
	<h1>
		<br>
		<spring:message code="label.signuppage.header" />
	</h1>
	...
	<form:form method="post" commandName="userRegistrationDTO"
		...
		<table>
			<tr>
				...
				<td><form:input type="text" path="name" maxlength="50"
						value="${userRegistrationDTO.name}" /></td>
				<td><form:errors path="name" cssClass="error" /></td>
			</tr>
			<tr>
				<td><spring:message code="label.signuppage.login" /></td>
				<td><form:input type="text" path="login" maxlength="50"
						value="${userRegistrationDTO.login}" /></td>
			...
			<tr>
				<td><button>
						<spring:message code="label.signuppage.buttonRegister" />
					</button></td>
			</tr>
		</table>
	</form:form>
